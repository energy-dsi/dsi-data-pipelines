...
│   ├── equip-boundary/
├── mapper/
    ├── equip-boundary-schema-assurance-producer/
    ├── equip-boundary-security-labels-producer/
    └── steady-hypothesis-schema-assurance-consumer/
```
...
For additional info you can always check the branch containing the [pipelines](https://github.com/energy-dsi/dsi-data-pipelines/tree/mesh-pipelines) used on the tests performed during the development.
