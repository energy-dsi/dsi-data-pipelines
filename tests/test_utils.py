...
from adaptor.utils import get_k8_secret
from adaptor.utils import get_blob_object

from azure.core.exceptions import ResourceNotFoundError

class TestAdaptorUtils(unittest.TestCase):

    @patch('adaptor.utils.client.CoreV1Api')
    @patch('adaptor.utils.config.load_kube_config')
    ...
    @patch("adaptor.utils.BlobServiceClient")
